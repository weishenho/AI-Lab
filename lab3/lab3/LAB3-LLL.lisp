...
;;the agent traverse all the square on the grid
(defun smart-traversal-vacuum-agent-with-gps-program (percept)
     (destructuring-bind (bump dirt home loc heading) (subseq percept 0 5) (setf nextmove nil)
       (cond (dirt 'suck)
         ( (and (equal loc '(6 1)) (equal heading (@ 1 0))) '(turn left)) ;; move rightward until the the wall at 6,1 then turn left
         ( (and (equal loc '(6 2)) (equal heading (@ 0 1))) '(turn left)) ;; turn left at 6 2 and move all the way leftward

         ( (and (equal loc '(1 2)) (equal heading (@ -1 0))) '(turn right)) ;; move right at 1 2 and move forward
         ( (and (equal loc '(1 3)) (equal heading (@ 0 1))) '(turn right)) ;; move right at 1 3 and move all the way rightward

         ( (and (equal loc '(6 3)) (equal heading (@ 1 0))) '(turn left)) ;; move right at 6 3 and move forward
         ( (and (equal loc '(6 4)) (equal heading (@ 0 1))) '(turn left)) ;; move right at 1 3 and move all the way leftward

         ( (and (equal loc '(1 4)) (equal heading (@ -1 0))) '(turn right)) ;; move right at 1 4 and move forward
         ( (and (equal loc '(1 5)) (equal heading (@ 0 1))) '(turn right)) ;; move right at 1 5 and move all the way rightward

         ( (and (equal loc '(6 5)) (equal heading (@ 1 0))) '(turn left)) ;; move right at 6 5 and move forward
         ( (and (equal loc '(6 6)) (equal heading (@ 0 1))) '(turn left)) ;; move right at 6 6 and move all the way leftward
